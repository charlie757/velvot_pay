...
class BillNumberProvider extends ChangeNotifier{
 ...
 data = {
  ...
  checkValidation(String serviceId,String operatorName,String operatorImage,String minAmount,String maxAmount,  String route){
    ...
    if(formKey.currentState!.validate()){
      route=='electricity'||route=='topup'?
          AppRoutes.pushNavigation(PayScreen(route: route, data: data,isFromSearchNumberRoute:'')):
      AppRoutes.pushNavigation(ChoosePlanScreen(serviceId: serviceId, operatorName: operatorName, operatorImage: operatorImage,
        data: data,isFromSearchNumberRoute: '',
        route: route,));
      print("data...$data");
