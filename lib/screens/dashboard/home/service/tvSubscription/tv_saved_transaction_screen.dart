...
class TvSavedTransactionScreen extends StatefulWidget {
  SavedTransactionModel? model;
   TvSavedTransactionScreen({required this.model});

  @override
  State<TvSavedTransactionScreen> createState() => _TvSavedTransactionScreenState();
}

class _TvSavedTransactionScreenState extends State<TvSavedTransactionScreen> {
  int selectedIndex = -1;
  @override
