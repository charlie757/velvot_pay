...
class _TvSubscriptionScreenState extends State<TvSubscriptionScreen> {
  ...
  callInitFunction() async {
    final provider =
        Provider.of<TvSubscriptionProvider>(context, listen: false);
                      ...
                      ? Container(
                          ...
                          child: ClipRRect(
                              ...
                              child: NetworkImagehelper(
                                img: myProvider
                                    .model!
                                    .data![myProvider.currentOperatorIndex]
                                    .image,
                                height: 24.0,
                                width: 24.0,
                              )),
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          Padding(
            ...
            child: Row(
              children: [
                ...
                InkWell(
                  onTap: () {
                    AppRoutes.pushNavigation(TvSavedTransactionScreen(
                      model: serviceProvider.savedTransactionModel ?? null,
                    ));
                  },
                  child: getText(
                      title: 'See All',
          ...
          serviceProvider.savedTransactionModel != null &&
                  serviceProvider.savedTransactionModel!.data != null
              ? SingleChildScrollView(
                  scrollDirection: Axis.horizontal,
                  child: Row(
                    children:
                        serviceProvider.savedTransactionModel!.data!.map((e) {
                      return Container(
                        ...
                        child: Row(
                          children: [
                            ...
                            Column(
                              ...
                              children: [
                                getText(
                                    title: e.request!.operator!.title,
                                    size: 12,
                                    fontFamily: Constants.galanoGrotesqueMedium,
                                    color: const Color(0xff51525C),
                                    fontWeight: FontWeight.w500),
                                getText(
                                    title: e.request!.phone,
                                    size: 12,
                                    fontFamily:
                                        Constants.galanoGrotesqueRegular,
                                    color: const Color(0xff51525C),
                                    fontWeight: FontWeight.w400),
                              ],
                            )
                                ...
                                return GestureDetector(
                                  onTap: () {
                                    ...
                                    provider.providerController.text =
                                        model.title;
                                    Navigator.pop(context);
                                    provider.getTVSubscriptionPlanApiFunction(
                                        model.serviceID);
                                    state(() {});
                                    setState(() {});
                                  },
            ...
            return Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  ScreenSize.height(25),
                  provider.tvSubscriptionPlanModel != null &&
                          provider.tvSubscriptionPlanModel!.data != null
                      ? Expanded(
                          child: ListView.separated(
                              separatorBuilder: (context, sp) {
                                return ScreenSize.height(15);
                              },
                              itemCount: provider.tvSubscriptionPlanModel!.data!
                                  .varations!.length,
                              shrinkWrap: true,
                              itemBuilder: (context, index) {
                                var model = provider.tvSubscriptionPlanModel!
                                    .data!.varations![index];
                                return GestureDetector(
                                  onTap: () {
                                  ...
                                  child: Container(
                                    ...
                                    decoration: BoxDecoration(
                                        ...
                                        borderRadius: BorderRadius.circular(8),
                                        border: Border.all(
                                          color: provider.selectedBundleIndex ==
                                                  index
                                              ? AppColor.appColor
  ...
  confirmationBottomSheet(
    TvSubscriptionProvider provider,
  ) {
    showModalBottomSheet(
        isScrollControlled: true,
        backgroundColor: AppColor.whiteColor,
          ...
          return Container(
            ...
            child: Column(
              ...
              children: [
                ...
                ScreenSize.height(4),
                getText(
                    title: 'Confirm your details before proceeding',
                    size: 14,
                    fontFamily: Constants.galanoGrotesqueRegular,
                    color: const Color(0xff51525C),
                    fontWeight: FontWeight.w400),
                ScreenSize.height(24),
                rowColumnForConfirmationWidget(
                    'LCU No', provider.icuNoController.text),
                ScreenSize.height(16),
                rowColumnForConfirmationWidget(
                    'Bundle', provider.bundleController.text),
                ScreenSize.height(16),
                rowColumnForConfirmationWidget(
                    'Amount',
                    provider
                            .tvSubscriptionPlanModel!
                            .data!
                            .varations![provider.selectedBundleIndex]
                            .variationAmount ??
                        ''),
                ScreenSize.height(16),
                ...
                ScreenSize.height(24),
                rowColumnForConfirmationWidget('Total Payment',
                    '₦${provider.tvSubscriptionPlanModel!.data!.varations![provider.selectedBundleIndex].variationAmount ?? ''}'),
                ScreenSize.height(24),
                CustomBtn(
                    title: "Confirm",
                    onTap: () {
                              ...
                              : index == 11
                                  ? GestureDetector(
                                      ...
                                      child: Container(
                                        alignment: Alignment.center,
                                        child:
                                            SvgPicture.asset(Images.cancelSvg),
                                      ),
                                    )
                                  : GestureDetector(
                                      onTap: () {
                                      ...
                                      child: Container(
                                        ...
                                        child: getText(
                                            ...
                                            size: 24,
                                            fontFamily:
                                                Constants.galanoGrotesqueMedium,
