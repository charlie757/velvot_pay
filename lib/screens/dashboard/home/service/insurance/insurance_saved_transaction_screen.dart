...
class InsuranceSavedTransactionScreen extends StatefulWidget {
  SavedTransactionModel? model;
   InsuranceSavedTransactionScreen({required this.model});

  @override
  State<InsuranceSavedTransactionScreen> createState() => _InsuranceSavedTransactionScreenState();
}

class _InsuranceSavedTransactionScreenState extends State<InsuranceSavedTransactionScreen> {
