...
class _BuyElectricityScreenState extends State<BuyElectricityScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Consumer<ElectricityProvider>(builder: (context, myProvider, child) {
      return Scaffold(
          ...
          child: SingleChildScrollView(
            ...
            child: Column(
              ...
              children: [
                ...
                myProvider.electricityPlanModel != null &&
                        myProvider.electricityPlanModel!.data != null
                    ? Container(
                        ...
                        child: getText(
                            title: myProvider
                                    .electricityPlanModel!.data!.customerName ??
                                '',
                            size: 14,
                            fontFamily: Constants.galanoGrotesqueMedium,
          ...
          Padding(
            ...
            child: Row(
              children: [
                ...
                InkWell(
                  onTap: () {
                    AppRoutes.pushNavigation(ElectricitySavedTransactionScreen(
                      model: serviceProvider.savedTransactionModel != null
                          ? serviceProvider.savedTransactionModel!
                          : null,
                    ));
                  },
                  child: getText(
                  ...
                  GestureDetector(
                    ...
                    child: Container(
                      ...
                      child: Row(
                        children: [
                          customRadioButton(
                            provider.selectedBillTypeIndex == 0 ? true : false,
                          ),
                          ScreenSize.width(10),
                          Text('Prepaid',
                              style: TextStyle(
                  ...
                  GestureDetector(
                    ...
                    child: SizedBox(
                      ...
                      child: Row(
                        children: [
                          customRadioButton(
                            provider.selectedBillTypeIndex == 1 ? true : false,
                          ),
                          ScreenSize.width(10),
                          Text("Postpaid",
                              style: TextStyle(
            ...
            child: Column(
              ...
              children: [
                ...
                getText(
                    ...
                    fontWeight: FontWeight.w400),
                ScreenSize.height(24),
                rowColumnForConfirmationWidget('Name',
                    provider.electricityPlanModel!.data!.customerName ?? ""),
                ScreenSize.height(16),
                rowColumnForConfirmationWidget(
                    'Meter No', provider.meterNumberController.text),
                ScreenSize.height(16),
                rowColumnForConfirmationWidget(
                    'Meter Type', provider.meterTypeController.text),
                ScreenSize.height(16),
                rowColumnForConfirmationWidget(
                    'Transfer Amount', '₦${provider.amountController.text}'),
                ScreenSize.height(16),
                ...
                ScreenSize.height(24),
                rowColumnForConfirmationWidget(
                    'Total Payment', '₦${provider.amountController.text}'),
                ScreenSize.height(24),
                CustomBtn(
                    title: "Confirm",
                    onTap: () {
